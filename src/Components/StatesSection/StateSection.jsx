...
const StatsSection = () => {
    ...
    return (
        <section className=" text-highlight-100 mt-20 md:mt-28">
            <h2 className="text-2xl sm:text-3xl font-bold mb-12 flex items-center justify-center gap-3 text-white">
                <PiFilmSlateFill className="text-4xl animate-pulse" /> MovieMaster <span className='text-highlight'>Pro</span> - By The Numbers
            </h2>
