...
const Footer = () => {
  return (
    <footer className="footer pt-16 pb-10 bg-neutral text-neutral-content relative overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 items-start">
          ...
          <nav className="flex flex-col items-center md:items-start space-y-4">
            <h6 className="footer-title text-lg font-bold uppercase">Social Links</h6>
