...
const nonAdminUsers = users.filter(user => user.role !== 'admin');
  ...
  if (loading) return <div className="min-h-screen flex justify-center items-center"><span className="loading loading-bars loading-lg text-highlight"></span></div>;

  return (
    <div className="min-h-screen bg-secondary p-6 lg:p-12 pt-28">
      <title>MOVIEMASTERpro | Dashboard</title>
      <div className="max-w-7xl mx-auto">
        <header className="mb-10 flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            <h1 className="text-4xl font-black italic text-highlight">Admin Control Panel</h1>
  ...
  <Link to="/dashboard/profile-settings">
    <button className="btn btn-outline btn-sm rounded-2xl gap-2">
    ...
    <button className="btn btn-outline btn-sm rounded-2xl gap-2">
      ...
      Movie Management
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <motion.div whileHover={{ scale: 1.02 }} className="bg-primary text-white p-8 rounded-2xl shadow-xl flex justify-between items-center">
            <div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} className="bg-primary-100 text-white p-8 rounded-2xl shadow-xl flex justify-between items-center">
            <div>
        ...
        <div className="bg-secondary rounded-2xl p-8 border border-base-300">
          ...
          <div className="overflow-x-auto">
                    ...
                    {/* --- Quick Stats Chart --- */}
        <div className="bg-secondary rounded-2xl p-8 border border-base-300 mb-12">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <YAxis />
              <Tooltip />
              <Bar dataKey="value" fill="#ff8c1a" radius={[10, 10, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
            ...
            <table className="table w-full border-separate border-spacing-y-3">
              ...
              <tbody>
                ...
                {nonAdminUsers.map((user) => (
                  <tr key={user._id} className="bg-secondary shadow-sm">
                    ...
                    <td className="text-center rounded-r-2xl">
                      <button 
                        ...
                        className="btn  btn-ghost hover:bg-error/10"
                      >
